$PBExportHeader$w_rowsmove.srw
forward
global type w_rowsmove from window
end type
type cb_autorun from commandbutton within w_rowsmove
end type
type st_error from statictext within w_rowsmove
end type
type dw_2 from datawindow within w_rowsmove
end type
type lb_testitems from listbox within w_rowsmove
end type
type cb_run from commandbutton within w_rowsmove
end type
type cb_saveas from commandbutton within w_rowsmove
end type
type cb_error from commandbutton within w_rowsmove
end type
type cbx_right from checkbox within w_rowsmove
end type
type cb_max from commandbutton within w_rowsmove
end type
type cb_1 from commandbutton within w_rowsmove
end type
type cb_sort from commandbutton within w_rowsmove
end type
type cb_reset from commandbutton within w_rowsmove
end type
type dw_1 from datawindow within w_rowsmove
end type
type dw_output from datawindow within w_rowsmove
end type
type gb_1 from groupbox within w_rowsmove
end type
type gb_2 from groupbox within w_rowsmove
end type
type gb_3 from groupbox within w_rowsmove
end type
type gb_4 from groupbox within w_rowsmove
end type
type gb_5 from groupbox within w_rowsmove
end type
end forward
...
string ls_message[]
ls_message[]={'[±àºÅ]','','RowsMove '+string(ii_number,"000"),''}
ii_number++
...
f_outputtext(dw_output,ls_message)
ls_message[]= {"[²Ù×÷]","",'click "Test"->"RowsMove"',""}
f_outputtext(dw_output,ls_message)
...
ls_item[1]="RowStatus Rowsmove() in differ datawindow and same buffer"
ls_item[2]="RowStatus Rowsmove() in differ datawindow and differ buffer"
ls_item[3]="RowStatus Rowsmove() in same datawindow and differ buffer"
ls_item[4]="ColumnStatus Rowsmove() in differ datawindow and same buffer"
ls_item[5]="ColumnStatus Rowsmove() in differ datawindow and differ buffer"
ls_item[6]="ColumnStatus Rowsmove() in same datawindow and differ buffer"
	...
	if lb_testitems.State(li_ItemCount)=1 then
		...
		choose case li_ItemCount
			case 1
				...
				f_check_Rowsmove(dw_output,dw_1,false,1,cbx_right.checked,dw_2)
			case 2
				wf_message(lb_testitems.text(li_ItemCount),"")
				f_check_Rowsmove(dw_output,dw_1,false,2,cbx_right.checked,dw_2)
			case 3
				wf_message(lb_testitems.text(li_ItemCount),"")
				f_check_Rowsmove(dw_output,dw_1,false,3,cbx_right.checked,dw_2)
			case 4
				wf_message(lb_testitems.text(li_ItemCount),"")
				f_check_Rowsmove(dw_output,dw_1,false,4,cbx_right.checked,dw_2)
			case 5
				wf_message(lb_testitems.text(li_ItemCount),"")
				f_check_Rowsmove(dw_output,dw_1,false,5,cbx_right.checked,dw_2)
			case 6
				wf_message(lb_testitems.text(li_ItemCount),"")
				f_check_Rowsmove(dw_output,dw_1,false,6,cbx_right.checked,dw_2)
			case 7
				wf_message(lb_testitems.text(li_ItemCount),"")
				f_check_Rowsmove(dw_output,dw_1,false,7,cbx_right.checked,dw_2)
...
event clicked;delete from status where flag='y';
f_check_Rowsmove(dw_output,dw_1,true,0,true,dw_2)
