$PBExportHeader$w_dwitemstatus.srw
forward
global type w_dwitemstatus from window
end type
type st_message from statictext within w_dwitemstatus
end type
type cbx_showright from checkbox within w_dwitemstatus
end type
type st_error from statictext within w_dwitemstatus
end type
type cb_autorun from commandbutton within w_dwitemstatus
end type
type cb_4 from commandbutton within w_dwitemstatus
end type
type cb_2 from commandbutton within w_dwitemstatus
end type
type lb_testitems from listbox within w_dwitemstatus
end type
type cb_run from commandbutton within w_dwitemstatus
end type
type cb_saveas from commandbutton within w_dwitemstatus
end type
type cb_error from commandbutton within w_dwitemstatus
end type
type cbx_right from checkbox within w_dwitemstatus
end type
type cb_max from commandbutton within w_dwitemstatus
end type
type cb_1 from commandbutton within w_dwitemstatus
end type
type cb_sort from commandbutton within w_dwitemstatus
end type
type cb_reset from commandbutton within w_dwitemstatus
end type
type dw_1 from datawindow within w_dwitemstatus
end type
type dw_output from datawindow within w_dwitemstatus
end type
type gb_1 from groupbox within w_dwitemstatus
end type
type gb_2 from groupbox within w_dwitemstatus
end type
type gb_3 from groupbox within w_dwitemstatus
end type
type gb_4 from groupbox within w_dwitemstatus
end type
type gb_5 from groupbox within w_dwitemstatus
end type
end forward
...
global w_dwitemstatus w_dwitemstatus
...
f_outputtext(dw_output,ls_message)
ls_message[]= {"[²Ù×÷]","",'click "Test"->DwItemStatus"',""}
f_outputtext(dw_output,ls_message)
...
ls_item[1]="RowStatus SetItemStatus()"
ls_item[2]="RowStatus InsertRow()"
ls_item[3]="RowStatus data expression"
ls_item[4]="ColumnStatus SetItemStatus()"
ls_item[5]="ColumnStatus InsertRow()"
ls_item[6]="ColumnStatus Data expression"
ls_item[7]="Lockstatus"
...
FOR li_ItemCount = 1 to li_ItemTotal
	...
	if lb_testitems.State(li_ItemCount)=1 then
		...
		choose case li_ItemCount
			case 1
				f_check_dwitemstatus(dw_output,dw_1,false,1,cbx_right.checked)
			case 2
				f_check_dwitemstatus(dw_output,dw_1,false,2,cbx_right.checked)
			case 3
				f_check_dwitemstatus(dw_output,dw_1,false,3,cbx_right.checked)
			case 4
				f_check_dwitemstatus(dw_output,dw_1,false,4,cbx_right.checked)
			case 5
				f_check_dwitemstatus(dw_output,dw_1,false,5,cbx_right.checked)
			case 6
				f_check_dwitemstatus(dw_output,dw_1,false,6,cbx_right.checked)
			case 7
				f_check_dwitemstatus(dw_output,dw_1,false,7,cbx_right.checked)				
		end choose
...
event clicked;delete from status where flag='d';
f_check_dwitemstatus(dw_output,dw_1,true,0,true)
