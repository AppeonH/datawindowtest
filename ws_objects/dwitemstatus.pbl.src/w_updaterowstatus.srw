$PBExportHeader$w_updaterowstatus.srw
forward
global type w_updaterowstatus from window
end type
type cb_autorun from commandbutton within w_updaterowstatus
end type
type st_error from statictext within w_updaterowstatus
end type
type dw_2 from datawindow within w_updaterowstatus
end type
type lb_testitems from listbox within w_updaterowstatus
end type
type cb_run from commandbutton within w_updaterowstatus
end type
type cb_saveas from commandbutton within w_updaterowstatus
end type
type cb_error from commandbutton within w_updaterowstatus
end type
type cbx_right from checkbox within w_updaterowstatus
end type
type cb_max from commandbutton within w_updaterowstatus
end type
type cb_1 from commandbutton within w_updaterowstatus
end type
type cb_sort from commandbutton within w_updaterowstatus
end type
type cb_reset from commandbutton within w_updaterowstatus
end type
type dw_1 from datawindow within w_updaterowstatus
end type
type dw_output from datawindow within w_updaterowstatus
end type
type gb_1 from groupbox within w_updaterowstatus
end type
type gb_2 from groupbox within w_updaterowstatus
end type
type gb_3 from groupbox within w_updaterowstatus
end type
type gb_4 from groupbox within w_updaterowstatus
end type
type gb_5 from groupbox within w_updaterowstatus
end type
end forward
...
global w_updaterowstatus w_updaterowstatus
...
f_outputtext(dw_output,ls_message)
ls_message[]= {"[²Ù×÷]","",'click "Test"->"UpdateRowStatus"',""}
f_outputtext(dw_output,ls_message)
...
ls_item[1]="RowStatus Update()"
ls_item[2]="RowStatus Update(true, false)"
ls_item[3]="RowStatus ResetUpdate()"
...
FOR li_ItemCount = 1 to li_ItemTotal
	...
	if lb_testitems.State(li_ItemCount)=1 then
		...
		choose case li_ItemCount
			case 1
				f_check_updaterowstatus(dw_output,dw_1,false,1,cbx_right.checked)
			case 2
				f_check_updaterowstatus(dw_output,dw_1,false,2,cbx_right.checked)
			case 3
				f_check_updaterowstatus(dw_output,dw_1,false,3,cbx_right.checked)
		end choose
...
event clicked;delete from status where flag='x';
f_check_updaterowstatus(dw_output,dw_1,true,0,true)
