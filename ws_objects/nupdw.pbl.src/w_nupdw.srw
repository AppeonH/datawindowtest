$PBExportHeader$w_nupdw.srw
forward
global type w_nupdw from window
end type
type cb_2 from commandbutton within w_nupdw
end type
type dw_bak from datawindow within w_nupdw
end type
type cbx_showright from checkbox within w_nupdw
end type
type dw_3 from datawindow within w_nupdw
end type
type cb_run from commandbutton within w_nupdw
end type
type st_message from statictext within w_nupdw
end type
type lb_testitems from listbox within w_nupdw
end type
type cb_autorun from commandbutton within w_nupdw
end type
type cb_saveas from commandbutton within w_nupdw
end type
type cb_error from commandbutton within w_nupdw
end type
type cbx_right from checkbox within w_nupdw
end type
type cb_max from commandbutton within w_nupdw
end type
type cb_sort from commandbutton within w_nupdw
end type
type cb_reset from commandbutton within w_nupdw
end type
type dw_1 from datawindow within w_nupdw
end type
type dw_output from datawindow within w_nupdw
end type
type gb_4 from groupbox within w_nupdw
end type
type gb_1 from groupbox within w_nupdw
end type
type gb_2 from groupbox within w_nupdw
end type
type gb_3 from groupbox within w_nupdw
end type
type lb_1 from listbox within w_nupdw
end type
end forward
...
string ls_message[]
ls_message[]={'[±àºÅ]','','NupDW '+string(ii_number,"000"),''}
ii_number++
f_outputtext(dw_output,ls_message)
...
f_outputtext(dw_output,ls_message)
ls_message[]= {"[²Ù×÷]","",'click "Test"->"N-UpDW"',""}
f_outputtext(dw_output,ls_message)
...
dw_1.dataobject = "d_nup_2"
dw_1.settransobject(sqlca)
dw_1.retrieve()

ls = dw_1.describe("DataWindow.QueryMode")
wf_output("QueryMode",'no',ls,'dw_1.Describe("DataWindow.QueryMode")=')
ls = dw_1.Object.DataWindow.QueryMode
wf_output("QueryMode",'no',ls,'dw_1.Object.DataWindow.QueryMode=')

ls = dw_1.describe("DataWindow.QuerySort")
wf_output("Columns.Spacing",'no',ls,'dw_1.Describe("DataWindow.QuerySort")=')
ls = dw_1.Object.DataWindow.QuerySort
wf_output("Columns.Spacing",'no',ls,'dw_1.Object.DataWindow.QuerySort=')
...
dw_1.settransobject(sqlca)
dw_1.retrieve()
wf_output('retrieve','retrievestart,sqlpreview,rowfocuschanging,rowfocuschanged,itemfocuschanged,retrieveend,',is_event,'dw_1.retrieve()')
...
wf_output('rowscopy','rowfocuschanging,rowfocuschanged,itemfocuschanged,',is_event,'dw_1.rowscopy(1,3,primary!,dw_1,1,primary!)')
...
is_event = ""
dw_1.setrow(3)
wf_output('setrow','rowfocuschanging,rowfocuschanged,itemfocuschanged,',is_event,'dw_1.setrow(3)')

//scrolltorow
is_event = ""
dw_1.scrolltorow(1)
wf_output('scrolltorow','rowfocuschanging,rowfocuschanged,itemfocuschanged,',is_event,'dw_1.scrolltorow(1)')
...
dw_1.sort()
wf_output('sort','itemfocuschanged,',is_event,'dw_1.sort()')
...
wf_output('insertrow(0)',f_string(li + 1),f_string(dw_1.rowcount()),'dw_1.rowcount()')
...
li = dw_1.getrow()
dw_1.scrolltorow(4)
wf_output('scrolltorow','4',f_string(dw_1.getrow()),'dw_1.scrolltorow(4)')

//getColumn
li = dw_1.getcolumn()
wf_output('getcolumn','1',f_string(li),'dw_1.getcolumn()')

//getColumnName
ls = dw_1.getcolumnName()
wf_output('getcolumnname','emp_id_2',ls,'dw_1.getcolumnname()')

//setColumnSuccede
li = dw_1.setcolumn(4)
wf_output('setcolumn','1',f_string(li),'dw_1.setcolumn(4)')
li = dw_1.getcolumn()
wf_output('getcolumn','4',f_string(li),'dw_1.getcolumn()')

//setColumnFail
li = dw_1.setcolumn(100)
wf_output('setcolumn','-1',f_string(li),'dw_1.setcolumn(100)')
li = dw_1.getcolumn()
wf_output('getcolumn','4',f_string(li),'dw_1.getcolumn(4)')

//getTextSucceed
ls = dw_1.gettext()
wf_output('gettext','Concord',ls,'dw_1.gettext()')
...
wf_output('gettext','settext',dw_1.gettext(),'dw_1.gettext()')

//selecttext
dw_1.setrow(1)
dw_1.setcolumn(2)
li = dw_1.selecttext(1,5)
wf_output('selecttext','5',f_string(li),'dw_1.selecttext(1,5)')


//clear
li = dw_1.clear()
wf_output('clear','5',f_string(li),'dw_1.clear()')

//copy
li = dw_1.copy()
wf_output('copy','0',f_string(li),'dw_1.copy()')

//cut
li = dw_1.cut()
wf_output('cut','0',f_string(li),'dw_1.cut()')

//paste
ls = "paste"
clipboard(ls)
li = dw_1.paste()
wf_output('paste','5',f_string(li),'dw_1.paste()')

//selectedtext
li = dw_1.selecttext(1,5)
wf_output('selecttext','5',f_string(li),'dw_1.selecttext(1,5)')
ls = dw_1.selectedtext()
wf_output('selectedtext','paste',ls,'dw_1.selectedtext()')

//selectedlength
wf_output('selectedlength','5',f_string(dw_1.selectedlength()),'dw_1.selectedlength()')
...
//replacetext
wf_output('replacetext','11',f_string(dw_1.replacetext("replacetext")),'dw_1.replacetext()')

//create
ls_create = "CREATE column(band=header id=2 row_in_detail=2 alignment='1' tabsequence=1 border='0' color='10' x='10' y='4' height='64' width='0' name=create_test font.face='Arial' font.height='-10' protect='0	if (IsRowNew(), 0, 1)' font.weight='400'  font.family='2' font.pitch='2' font.charset='0' background.mode='2' background.color='16777215	if (IsRowNew(), rgb(255,255,255), 79741120)' )"
...
wf_output('2page','page() = 2',ls,"dw_1.getitemstring(11,'page')")


//pagecount
//ls = dw_1.getitemstring(1,'pagecount')
//wf_output('1pagecount','pagecount() = 8',ls,"dw_1.getitemstring(1,'pagecount')")

//ls = dw_1.getitemstring(11,'pagecount')
//wf_output('2pagecount','pagecount() = 8',ls,"dw_1.getitemstring(11,'pagecount')")
