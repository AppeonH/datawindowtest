...
type dw_2 from datawindow within w_graph
end type
type dw_bak from datawindow within w_graph
end type
type cbx_showright from checkbox within w_graph
end type
type cb_2 from commandbutton within w_graph
end type
type cb_run from commandbutton within w_graph
end type
type st_message from statictext within w_graph
end type
type lb_testitems from listbox within w_graph
end type
type cb_autorun from commandbutton within w_graph
end type
type cb_10 from commandbutton within w_graph
end type
type cb_3 from commandbutton within w_graph
end type
type cbx_right from checkbox within w_graph
end type
type cb_max from commandbutton within w_graph
end type
type cb_save from commandbutton within w_graph
end type
type cb_sort from commandbutton within w_graph
end type
type cb_reset from commandbutton within w_graph
end type
type dw_1 from datawindow within w_graph
end type
type dw_output from datawindow within w_graph
end type
type gb_4 from groupbox within w_graph
end type
type gb_1 from groupbox within w_graph
end type
type gb_2 from groupbox within w_graph
end type
type gb_3 from groupbox within w_graph
end type
type lb_1 from listbox within w_graph
end type
end forward
...
dw_2.retrieve()
dw_2.importfile('c:\graph_default_property')
end event
...
wf_script(trim(mid(ls_item,pos(lb_testitems.text(lb_testitems.selectedindex()),"Group:") + 6)),false)
